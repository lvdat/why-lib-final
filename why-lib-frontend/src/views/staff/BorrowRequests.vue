        ...
        <table class="min-w-full bg-white rounded-lg overflow-hidden">
          ...
          <tbody class="divide-y divide-gray-200">
            <tr v-for="request in borrowRequests" :key="request._id">
              ...
              <td class="py-3 px-4">
                <span :class="{
                  'bg-yellow-100 text-yellow-800': request.TRANGTHAI === 'Chờ duyệt',
                  'bg-green-100 text-green-800': request.TRANGTHAI === 'Đã duyệt',
              ...
              <td class="py-3 px-4">
                <div v-if="request.TRANGTHAI === 'Chờ duyệt'" class="flex space-x-2">
                  <button
